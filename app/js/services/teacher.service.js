        ...
        execute: function() {
            TeacherService = (function () {
                ...
                TeacherService.prototype.addTeacher = function (teacher) {
                    ...
                    return this.http.post('http://localhost:8080/dziennik/teacher', JSON.stringify(teacher), headers);
                };
                ...
                TeacherService.prototype.getSubjectsByTeacherId = function (teacherID) {
                    ...
                    return this.http.get('http://localhost:8080/dziennik/subject', { search: parametrers })
                        .map(function (response) { return response.json(); })
                        .catch(this.handleError);
                };
                TeacherService.prototype.getStudentsByClassId = function (classID) {
                    ...
                    return this.http.get('http://localhost:8080/dziennik/student', { search: parametrers })
                        .map(function (response) { return response.json(); })
                        .catch(this.handleError);
                };
                TeacherService.prototype.getStudentsWithGradesByClassId = function (classID, subjectID) {
                    ...
                    return this.http.get('http://localhost:8080/dziennik/teacher/grades', { search: parametrers })
                        .map(function (response) { return response.json(); })
                        .catch(this.handleError);
                };
